...
[[nodiscard]] BoostSnapshot snapshot_from_samples(std::span<double const> samples_row_major,
...
[[nodiscard]] st::Result<BoostSnapshot>
snapshot_from_csv(std::string_view csv_path, PidMapping const &mapping, DetectorConfig const &cfg);
