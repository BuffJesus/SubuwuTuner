...
struct ColumnMapping {
    ...
    std::array<std::size_t, kSignalCount>      signal_idx{
        kNoColumn, kNoColumn, kNoColumn};
};
...
[[nodiscard]] HistorySnapshot snapshot_from_samples(
...
[[nodiscard]] st::Result<HistorySnapshot> snapshot_from_csv(
