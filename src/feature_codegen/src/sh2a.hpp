...
[[nodiscard]] constexpr std::uint16_t enc_mov_l_disp_pc(Reg rn, std::uint8_t disp) noexcept {
    return static_cast<std::uint16_t>(
        0xD000U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
...
[[nodiscard]] constexpr std::uint16_t enc_mov_l_reg_at_reg(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x2002U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_mov_l_at_reg_reg(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x6002U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_add(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x300CU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_sub(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x3008U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_mul_l(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x0007U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_sts_macl(Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x001AU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_cmp_eq(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x3000U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_cmp_gt(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x3007U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_movt(Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x0029U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_and(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x2009U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_or(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x200BU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_tst(Reg rm, Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x2008U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fadd(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF000U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
...
[[nodiscard]] constexpr std::uint16_t enc_fsub(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF001U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fmul(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF002U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fdiv(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF003U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_lds_r_fpul(Reg rm) noexcept {
    return static_cast<std::uint16_t>(
        0x405AU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rm) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_sts_fpul_r(Reg rn) noexcept {
    return static_cast<std::uint16_t>(
        0x005AU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(rn) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fsts_fpul_freg(FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF00DU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_flds_freg_fpul(FReg frm) noexcept {
    return static_cast<std::uint16_t>(
        0xF01DU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_float_fpul_freg(FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF02DU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_ftrc_freg_fpul(FReg frm) noexcept {
    return static_cast<std::uint16_t>(
        0xF03DU | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 8U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fcmp_eq(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF004U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 4U));
}
...
[[nodiscard]] constexpr std::uint16_t enc_fcmp_gt(FReg frm, FReg frn) noexcept {
    return static_cast<std::uint16_t>(
        0xF005U | static_cast<std::uint16_t>(static_cast<std::uint16_t>(frn) << 8U) |
        static_cast<std::uint16_t>(static_cast<std::uint16_t>(frm) << 4U));
}
