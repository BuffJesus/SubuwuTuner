...
inline constexpr char kStdCitation[] = "RomRaider's `src/main/java/com/romraider/maps/checksum/"
...
std::unique_ptr<IChecksumRepair> make_checksum_repair(ChecksumKind kind) {
    ...
    case ChecksumKind::SubaruStd:
        return std::make_unique<SubaruRepairStub<ChecksumKind::SubaruStd, kStdCitation>>();
    case ChecksumKind::SubaruAlt:
