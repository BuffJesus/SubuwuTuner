...
//
// st::devices::ap3::cipher::bzip2_decompress — layer 4 of the `.ptm`
...
//
// Gated by ST_AP3_HAVE_PTM_REWRITE (which requires
// ST_ENABLE_COBB_AP_PTM_REWRITE=ON at configure time). When undefined
// — either because ST_AP3_HAVE_CIPHER is off OR because the rewrite
