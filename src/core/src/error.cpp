...
std::string_view to_string(ErrorCode code) noexcept {
    switch (code) {
        ...
        case ErrorCode::BadMagic:             return "bad magic / signature";
        case ErrorCode::BadChecksum:          return "checksum mismatch";
        case ErrorCode::UnsupportedVersion:   return "unsupported version";
        case ErrorCode::TransportUnavailable: return "transport unavailable";
        case ErrorCode::TransportTimeout:     return "transport timeout";
        case ErrorCode::TransportNack:        return "transport negative-acknowledged";
        case ErrorCode::EcuRejected:          return "ECU rejected request";
        case ErrorCode::SeedKeyFailed:        return "seed/key authentication failed";
    }
