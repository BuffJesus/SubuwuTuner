...
│   └── cli/                               (subuwutuner-cli — rom-info, rom-pull, dump-axis, dump-table[--csv], rom-diff, table-edit, project-{new,info,edit,undo,redo}, pack-info, table-list, log, can-{replay,diff,discover,export-dbc,decode}, flash-{plan-info,delta,resume,apply,trace})
...
├── tests/unit/{core,rom,defs,edit,project,transport,ecu,log,can,dbc,discover}/   (269 C++ tests; 65 Python tests under tools/defgen/tests/)
