...
| Reason about brick-protection or flash safety | `docs/05-improvements.md` §4, `docs/31-brick-protection-by-isa.md` (per-ISA recipes), `docs/08-testing-strategy.md` Tier 4, `docs/43-jtag-recovery.md` (quarantined recovery reference; exact-board probe confirmation required) |
