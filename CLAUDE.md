...
│   ├── autotune/                          (st::autotune — MAF auto-tune algorithm per docs/12: per-cell trimmed-mean error → clamped delta with confidence)
