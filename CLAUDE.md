...
│   └── cli/                               (subuwutuner-cli — rom-info, rom-pull, dump-axis[--csv], dump-table[--csv], rom-diff, table-edit, project-{new,info,edit,undo,redo}, pack-info, table-list, policy, log, can-{replay,diff,discover,export-dbc,decode}, flash-{plan-info,delta,resume,apply,trace})
...
├── tests/unit/{core,rom,defs,edit,project,transport,ecu,log,can,dbc,discover,policy}/   (285 C++ tests; 81 Python tests under tools/defgen/tests/)
