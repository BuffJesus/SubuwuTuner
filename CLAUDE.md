...
│   └── cli/                               (subuwutuner-cli — rom-info, rom-pull, dump-axis, dump-table[--csv], rom-diff, table-edit, project-{new,info,edit,undo,redo}, pack-info, table-list, log, can-{replay,diff,discover,export-dbc,decode}, flash-{plan-info,delta,resume,apply})
