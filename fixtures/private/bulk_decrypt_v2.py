...
CONFIRMED = [
    ...
    ("PAK_EZ1GB20I",
     "roms_extracted/decrypted/EZ1G/EZ1GB20I.bin",
     "ez1gb20i_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GD00E",
     "roms_extracted/decrypted/EZ1G/EZ1GD00E.bin",
     "ez1gd00e_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GC00B",
     "roms_extracted/decrypted/EZ1G/EZ1GC00B.bin",
     "ez1gc00b_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GC00D",
     "roms_extracted/decrypted/EZ1G/EZ1GC00D.bin",
     "ez1gc00d_ori.hex", 1024, 0, 1049600),
    ("PAK_EE5I910U",
     "roms_extracted/decrypted/EE5I/EE5I910U.bin",
     "ee5i910u_ori.hex", 1024, 0, 1049600),
    ("PAK_DE5F201G",
     "roms_extracted/decrypted/DE5F/DE5F201G.bin",
     "de5f201g_ori.hex", 1024, 0, 1049600),
    ("PAK_DE5F810G",
     "roms_extracted/decrypted/DE5F/DE5F810G.bin",
     "de5f810g_ori.hex", 1024, 0, 1049600),
    ("PAK_EE5K801T",
     "roms_extracted/decrypted/EE5K/EE5K801T.bin",
     "ee5k801t_ori.hex", 1024, 0, 1049600),
    ("PAK_EE5K801V",
     "roms_extracted/decrypted/EE5K/EE5K801V.bin",
     "ee5k801v_ori.hex", 1024, 0, 1049600),
    ("PAK_DE5M301C",
     "roms_extracted/decrypted/DE5M/DE5M301C.bin",
     "de5m301c_ori.hex", 1024, 0, 1049600),
    ("PAK_DE5M301H",
     "roms_extracted/decrypted/DE5M/DE5M301H.bin",
     "de5m301h_ori.hex", 1024, 0, 1049600),
    ("PAK_EB4GI00B",
     "roms_extracted/decrypted/EB4G/EB4GI00B.bin",
     "eb4gi00b_ori.hex", 1024, 0, 1311488),
    ("PAK_EB4GI00C",
     "roms_extracted/decrypted/EB4G/EB4GI00C.bin",
     "eb4gi00c__ori.hex", 1024, 0, 1311488),
    ("PAK_EB4V900C",
     "roms_extracted/decrypted/EB4V/EB4V900C.bin",
     "eb4v900c_ori.hex", 1024, 0, 1311488),
    ("PAK_DB4GI00D",
     "roms_extracted/decrypted/DB4G/DB4GI00D.bin",
     "db4gi00d_ori.hex", 1024, 0, 1311488),
    ("PAK_EZ1GB10H",
     "roms_extracted/decrypted/EZ1G/EZ1GB10H.bin",
     "ez1gb10h_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GB10G",
     "roms_extracted/decrypted/EZ1G/EZ1GB10G.bin",
     "ez1gb10g_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5GD00B",
     "roms_extracted/decrypted/EP5G/EP5GD00B.bin",
     "ep5gd00b_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5GD00D",
     "roms_extracted/decrypted/EP5G/EP5GD00D.bin",
     "ep5gd00d_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5GD00A",
     "roms_extracted/decrypted/EP5G/EP5GD00A.bin",
     "ep5gd00a_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5IA00I",
     "roms_extracted/decrypted/EP5I/EP5IA00I.bin",
     "ep5ia00i_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5IA00G",
     "roms_extracted/decrypted/EP5I/EP5IA00G.bin",
     "ep5ia00g_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5I800F",
     "roms_extracted/decrypted/EP5I/EP5I800F.bin",
     "ep5i800f_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5L301G",
     "roms_extracted/decrypted/EP5L/EP5L301G.bin",
     "ep5l301g_ori.hex", 1024, 0, 1049600),
    ("PAK_EA1T600A",
     "roms_extracted/decrypted/EA1T/EA1T600A.bin",
     "ea1t600a_ori.hex", 1024, 0, 1311488),
    ("PAK_EP5IA00D",
     "roms_extracted/decrypted/EP5I/EP5IA00D.bin",
     "ep5ia00d_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5IA00B",
     "roms_extracted/decrypted/EP5I/EP5IA00B.bin",
     "ep5ia00b_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5I800A",
     "roms_extracted/decrypted/EP5I/EP5I800A.bin",
     "ep5i800a_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5L301B",
     "roms_extracted/decrypted/EP5L/EP5L301B.bin",
     "ep5l301b_ori.hex", 1024, 0, 1049600),
    ("PAK_EM2F401E",
     "roms_extracted/decrypted/EM2F/EM2F401E.bin",
     "em2f401e_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1T600B",
    ...
    ("PAK_LF9D040H",
     "roms_extracted/decrypted/LF9D/LF9D040H.bin",
     "lf9d040h__ori.hex", 25600, 0, 2622464),
    ("PAK_LHBHB10B00G",
     "roms_extracted/decrypted/LHBH/LHBHB10B00G.bin",
     "lhbhb10b_ori.hex", 66560, 0, 4195328),
    ("PAK_EZ1GC00F",
     "roms_extracted/decrypted/EZ1G/EZ1GC00F.bin",
     "ez1gc00f_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GC00E",
     "roms_extracted/decrypted/EZ1G/EZ1GC00E.bin",
     "ez1gc00e_ori.hex", 1024, 0, 1049600),
    ("PAK_EZ1GB10I",
     "roms_extracted/decrypted/EZ1G/EZ1GB10I.bin",
     "ez1gb10i_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5DB00B",
     "roms_extracted/decrypted/EP5D/EP5DB00B.bin",
     "ep5db00b_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5DA00A",
     "roms_extracted/decrypted/EP5D/EP5DA00A.bin",
     "ep5da00a_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5DB00D",
     "roms_extracted/decrypted/EP5D/EP5DB00D.bin",
     "ep5db00d_ori.hex", 1024, 0, 1049600),
    ("PAK_EP5DA00C",
     "roms_extracted/decrypted/EP5D/EP5DA00C.bin",
     "ep5da00c_ori.hex", 1024, 0, 1049600),
    ("PAK_EA1M511B",
    ...
    ("PAK_ZA1JB01D",
     "roms_extracted/decrypted/ZA1J/ZA1JB01D.bin",
     "ZA1JB01D_ori.hex", 1024, 0, 1311488),
    ("PAK_ZA1JB01C",
    ...
    ("PAK_EA1U300A",
     "roms_extracted/decrypted/EA1U/EA1U300A.bin",
     "ea1u300a_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1U300B",
     "roms_extracted/decrypted/EA1U/EA1U300B.bin",
     "ea1u300b_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1Y200D",
     "roms_extracted/decrypted/EA1Y/EA1Y200D.bin",
     "ea1y200d_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1Y200B",
     "roms_extracted/decrypted/EA1Y/EA1Y200B.bin",
     "ea1y200b_ori.hex", 1024, 0, 1311488),
    ("PAK_EB4J340R",
     "roms_extracted/decrypted/EB4J/EB4J340R.bin",
     "eb4j340r_ori.hex", 1024, 0, 1311488),
    ("PAK_EB4S200R",
    ...
    ("PAK_XH3J2C1A",
     "roms_extracted/decrypted/XH3J/XH3J2C1A.bin",
     "xh3j2c1a_ori.hex", 1024, 0, 1573632),
    ("PAK_XH3J2C0B",
     "roms_extracted/decrypted/XH3J/XH3J2C0B.bin",
     "xh3j2c0b_ori.hex", 1024, 0, 1573632),
    ("PAK_EA1T500V",
     "roms_extracted/decrypted/EA1T/EA1T500V.bin",
     "ea1t500v_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1T500W",
     "roms_extracted/decrypted/EA1T/EA1T500W.bin",
     "ea1t500w_ori.hex", 1024, 0, 1311488),
    ("PAK_EA1T500X",
    ...
    ("PAK_ZA1JS10C",
     "roms_extracted/decrypted/ZA1J/ZA1JS10C.bin",
     "ZA1JS10C_ori.hex", 1024, 0, 1311488),
    ("PAK_LT8DB00A",
     "roms_extracted/decrypted/LT8D/LT8DB00A.bin",
     "lt8db00a_ori.hex", 25600, 0, 2622464),
    ("PAK_XE1F900A",
     "roms_extracted/decrypted/XE1F/XE1F900A.bin",
     "xe1f900a_ori.hex", 1024, 0, 4064000),
]
