...
that's a separate project and is not part of the calibration we ship. Do not
conflate the physical links: the 2017 ECM terminal table lists general LIN
communication on E158-3 and a separate immobilizer communication circuit on
E158-43. The keyed-system transport has not yet been proven to be LIN.
