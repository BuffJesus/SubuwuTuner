...
TEST_CASE("j2534::PassThruMsg has the SAE-defined 4152-byte layout",
          "[transport][j2534]") {
    REQUIRE(sizeof(j2534::PassThruMsg) == 4152);
    REQUIRE(std::is_standard_layout_v<j2534::PassThruMsg>);
}

TEST_CASE("j2534::PassThruMsg field offsets match the v04.04 layout",
          "[transport][j2534]") {
...
TEST_CASE("j2534::SConfig is exactly 2 uint32_t fields",
          "[transport][j2534]") {
...
TEST_CASE("j2534::u32 is exactly 4 bytes (locks down vendor-DLL ABI)",
          "[transport][j2534]") {
...
TEST_CASE("j2534::ProtocolId values match the SAE v04.04 spec",
          "[transport][j2534]") {
...
TEST_CASE("j2534::status_message: every documented code maps to a "
    ...
    constexpr j2534::Status all[] = {
        j2534::Status::NoError,             j2534::Status::NotSupported,
        j2534::Status::InvalidChannelId,    j2534::Status::InvalidProtocolId,
        j2534::Status::NullParameter,       j2534::Status::InvalidIoctlValue,
        j2534::Status::InvalidFlags,        j2534::Status::Failed,
        j2534::Status::DeviceNotConnected,  j2534::Status::Timeout,
        j2534::Status::InvalidMsg,          j2534::Status::InvalidTimeInterval,
        j2534::Status::ExceededLimit,       j2534::Status::InvalidMsgId,
        j2534::Status::DeviceInUse,         j2534::Status::InvalidIoctlId,
        j2534::Status::BufferEmpty,         j2534::Status::BufferFull,
        j2534::Status::BufferOverflow,      j2534::Status::PinInvalid,
        j2534::Status::ChannelInUse,        j2534::Status::MsgProtocolId,
        j2534::Status::InvalidFilterId,     j2534::Status::NoFlowControl,
        j2534::Status::NotUnique,           j2534::Status::InvalidBaudrate,
...
TEST_CASE("j2534::status_message: unknown code → 'unknown J2534 status'",
          "[transport][j2534]") {
    j2534::u32 const bogus = 0xDEAD;
    REQUIRE(j2534::status_message(bogus) == "unknown J2534 status");
}

TEST_CASE("j2534::status_message: Failed code mentions GetLastError",
          "[transport][j2534]") {
...
extern "C" {
j2534::Status fake_open(void *, j2534::u32 *)              { return j2534::Status::NoError; }
j2534::Status fake_close(j2534::u32)                       { return j2534::Status::NoError; }
j2534::Status fake_connect(j2534::u32, j2534::u32, j2534::u32, j2534::u32, j2534::u32 *) {
    return j2534::Status::InvalidProtocolId;
}
j2534::Status fake_disconnect(j2534::u32)                  { return j2534::Status::NoError; }
...
j2534::J2534Library::FunctionTable make_full_table() noexcept {
    return {
        &fake_open,         &fake_close,         &fake_connect,
        &fake_disconnect,   &fake_read_msgs,     &fake_write_msgs,
        &fake_ioctl,        &fake_read_version,  &fake_get_last_error,
    };
}

} // namespace

TEST_CASE("j2534::J2534Library: holds an injected function table verbatim",
          "[transport][j2534]") {
...
TEST_CASE("j2534::J2534Library: forwarded function pointers still callable",
          "[transport][j2534]") {
...
TEST_CASE("j2534::FunctionTable::core_complete: true on full table",
          "[transport][j2534]") {
...
TEST_CASE("j2534::J2534Library::load: returns NotImplemented (stub)",
          "[transport][j2534]") {
...
TEST_CASE("j2534::J2534Library: move-construction transfers the table",
          "[transport][j2534]") {
