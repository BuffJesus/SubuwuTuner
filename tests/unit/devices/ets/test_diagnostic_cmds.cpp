...
// hidden behind ST_ETS_ENABLE_DIAGNOSTIC_CMDS=1. Off by default
...
struct DiagnosticEnvGuard {
    DiagnosticEnvGuard() {
#if defined(_WIN32)
        _putenv("ST_ETS_ENABLE_DIAGNOSTIC_CMDS=1");
#else
        setenv("ST_ETS_ENABLE_DIAGNOSTIC_CMDS", "1", 1);
#endif
    }
    ~DiagnosticEnvGuard() {
#if defined(_WIN32)
        _putenv("ST_ETS_ENABLE_DIAGNOSTIC_CMDS=");
#else
        unsetenv("ST_ETS_ENABLE_DIAGNOSTIC_CMDS");
#endif
    }
};
